...
class Bundle extends BundleBase {
  ...
  addModule(resolver, resolutionResponse, module, moduleTransport, bundleType, busindessModuleFile) {
   if (bundleType == 'c') {
    if(~moduleTransport.sourcePath.indexOf(busindessModuleFile)) {
      return
    }
   } else if (bundleType == 'b' ) {
    if(!~moduleTransport.sourcePath.indexOf(busindessModuleFile)) {
      return
    }
   }; 
