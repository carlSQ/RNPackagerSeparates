...
module.exports = [
  {
    ...
    command: 'bundleType',
    description: 'bundle type a,c,b, a is All bundle, c is coreBundle, b is businsess bundle',
    type: 'string',
    default: 'a',
  }, {
    command: 'busindessModuleFile',
    description: 'business module path',
    type: 'string',
    default: 'ReactComponents',
  }
];
